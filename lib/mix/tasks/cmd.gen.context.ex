defmodule Mix.Tasks.Cmd.Gen.Context do
  ...
  Read the documentation for `cmd.gen.schema` for more information on
  attributes.
  ...
  alias Mix.Commanded.{Context, Schema}
  ...
  def build(args, help \\ __MODULE__) do
    ...
    schema_module = inspect(Module.concat(context_name, schema_name)) |> dbg()
  ...
  defp inject_schema_access(%Context{file: file} = context, paths, binding) do
    ...
    |> Mix.Commanded.eval_from(
      "priv/templates/cmd.gen.context/#{schema_access_template(context)}",
      binding
    )
  ...
  #     Mix.Generator.create_file(test_file, Mix.Commanded.eval_from(paths, "priv/templates/cmd.gen.context/context_test.exs", binding))
  #   end
  # end
  #
  ...
  #
  #   paths
  #   |> Mix.Commanded.eval_from("priv/templates/cmd.gen.context/test_cases.exs", binding)
  ...
  #     Mix.Generator.create_file(test_fixtures_file, Mix.Commanded.eval_from(paths, "priv/templates/cmd.gen.context/fixtures_module.ex", binding))
  #   end
  # end
  #
  ...
  #
  #   paths
  #   |> Mix.Commanded.eval_from("priv/templates/cmd.gen.context/fixtures.ex", binding)
  #   |> Mix.Commanded.prepend_newline()
