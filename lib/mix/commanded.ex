defmodule Mix.Commanded do
  # Conveniences for Commanded tasks.
  @moduledoc false
  ...
  ## Examples
      ...
      iex> Mix.Commanded.inflect("user")
      [alias: "User",
       human: "User",
       base: "Commanded",
       web_module: "CommandedWeb",
       module: "Commanded.User",
       scoped: "User",
       singular: "user",
       path: "user"]

      iex> Mix.Commanded.inflect("Admin.User")
      [alias: "User",
       human: "User",
       base: "Commanded",
       web_module: "CommandedWeb",
       module: "Commanded.Admin.User",
       scoped: "Admin.User",
       singular: "user",
       path: "admin/user"]

      iex> Mix.Commanded.inflect("Admin.SuperUser")
      [alias: "SuperUser",
       human: "Super user",
       base: "Commanded",
       web_module: "CommandedWeb",
       module: "Commanded.Admin.SuperUser",
  ...
  def inflect(singular) do
    ...
    scoped = CmdGen.Naming.camelize(singular)
    path = CmdGen.Naming.underscore(scoped)
    singular = String.split(path, "/") |> List.last()
    module = Module.concat(base, scoped) |> inspect
    alias = String.split(module, ".") |> List.last()
    human = CmdGen.Naming.humanize(singular)
  ...
  defp app_base(app) do
    case Application.get_env(app, :namespace, app) do
      ^app -> app |> to_string() |> CmdGen.Naming.camelize()
      mod -> mod |> inspect()
    end
  end
  ...
  and falls back to Commanded's `priv` directory.
  """
    ...
    case Application.get_env(this_otp_app, :generators)[:context_app] do
      ...
      false ->
        ...
        via cli option:
            ...
            mix cmd.gen.[task] --context-app some_app
